...
<h3>partial</h3><p>Compare a partial path to a pattern.  As long as the parts of the path that
...
<h3>allowWindowsEscape</h3><p>Windows path separator <code>\</code> is by default converted to <code>/</code>, which
